...
class MainPageController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    //Tabla con los empleados y botones para ver el perfil del usuario logueado o crear uno nuevo si se es de administración o RRHH
    ...
    func getAllUsers() {
        ...
        NetworkingHelper().userList(success: { users in
